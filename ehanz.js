...
isForwarded: true, 
	...
	title: 'нσѕнιησ вσт © By ᴘᴜᴛʀᴀᴏғᴄ 汉 」',
...
let me = m.sender
let anu = "https://telegra.ph/file/5ae1a82c5baa94faf5513.jpg";
...
await ehz.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: 'нσѕнιησ вσт', mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl: vid.url,sourceUrl: `${sgc}`																												
...
https://chat.whatsapp.com/HVADsBHnAmz9iMuhXQ52Gp
`+readmore+`
...
await ehz.sendImageAsSticker(m.sender, agg.result.sticker[ki], m, { packname: "© нσѕнιησ вσт ν2", author: "By ᴘᴜᴛʀᴀᴏғᴄ 汉 」" })
} }
 break
 case 'sc': case 'script':{
    ...
    requestPaymentMessage: {
      ...
      extendedTextMessage: {
      text: `
      SCRIPT : https://chat.whatsapp.com/HVADsBHnAmz9iMuhXQ52Gp
      © Hoshino Bot V2
`,
      contextInfo: {
      externalAdReply: {
...
break
 ...
 case 'ai':
    case 'openai' : {
		if (!q) return setReply(`Ada Yang Bisa Hoshinol Bantu?`)			
m.reply(mess.wait)
...
ehz.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: `© нσѕнιησ вσт ν2`, mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl:"https://telegra.ph/file/33d58a3a7b931d3902642.jpg",sourceUrl: `https://wa.me/${nomerOwner}`
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/p.u.t8`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/p.u.t8`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `wa.me/628388198229`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `RangelChan`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/p.u.t8`,}
...
break
  case 'artinama': {
if (!q) return setReply( `Example : ${prefix + command} putra Dhoanx`)
...
break
 case 'pasangan': {
if (!q) return setReply( `Example : ${prefix + command} Putra|Hoshino`)
...
break
case 'runtime':{
setReply(`*© нσѕнιησ вσт ν2 Aktif* ${runtime(process.uptime())}`)
}
break
case 'owner': {
...
break
case 'putra': case '@628388198229': case '628388198229':
